...
## Описание
Конспекты по курсу "Ядро Linux" Павла Емельянова от кафедры Parallels

## Содержание
- [Interrupts Exceptions](https://github.com/Vipon/LinuxNotes/blob/master/Linux%20Interrupts%20Exceptions.md)
- [Lists](https://github.com/Vipon/LinuxNotes/blob/master/Linux%20Lists.md)
- [Memory System](https://github.com/Vipon/LinuxNotes/blob/master/Linux%20Memory%20System.md)
- [Process](https://github.com/Vipon/LinuxNotes/blob/master/Linux%20Process.md)
